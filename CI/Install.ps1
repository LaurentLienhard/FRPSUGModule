...
if (!(Get-Module -ListAvailable -Name Plaster | Where-Object { $_.Version -ge '1.1.3' })) {
...
if (!(Get-Module -ListAvailable -Name Pester | Where-Object { $_.Version -ge '4.7.3' })) {
...
if (!(Get-Module -ListAvailable -Name BuildHelpers | Where-Object { $_.Version -ge '2.0.8' })) {
    Write-Output "[INSTALL] BuilHelpers"
    Install-Module -Name BuildHelpers -MinimumVersion 2.0.8 -Scope CurrentUser -Force -Confirm:$false
}

if (!(Get-Module -ListAvailable -Name PSClassUtils | Where-Object { $_.Version -ge '2.6.3' })) {
