...
if (!(Get-Module -ListAvailable -Name Plaster | Where-Object { $_.Version -gt '1.1.3' })) {
...
if (!(Get-Module -ListAvailable -Name Pester | Where-Object { $_.Version -gt '4.7.3' })) {
...
if (!(Get-Module -ListAvailable -Name BuildHelpers | Where-Object { $_.Version -gt '2.0.8' })) {
    Write-Output "[INSTALL] Plaster"
    Install-Module -Name pester -MinimumVersion 2.0.8 -Scope CurrentUser -Force -Confirm:$false
}

if (!(Get-Module -ListAvailable -Name PSClassUtils | Where-Object { $_.Version -gt '2.6.3' })) {
